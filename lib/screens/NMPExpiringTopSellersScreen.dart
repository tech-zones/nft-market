                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              children: [
                                Image.network('$osImageBaseUrl/icons/os_ic_token.png', width: 25, height: 25, color: Theme.of(context).iconTheme.color),
                      ...
                      return ExpansionPanel(
                        ...
                        body: Container(
                          ...
                          child: ListTile(
                              ...
                              trailing: Image.network(data.categoryIcon!, width: 30, height: 30, color: Theme.of(context).iconTheme.color),
                              onTap: () {
                                //
                              }),
                        ),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Image.network('$osImageBaseUrl/icons/os_ic_token.png',
          ...
          children: [
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Image.network('$osImageBaseUrl/icons/os_ic_wolf.png', height: 24, width: 24),
                                            SizedBox(width: 8),
                                            Text(
                                              'Meta Mask',
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Image.network('$osImageBaseUrl/icons/os_ic_trustwallet.png', height: 24, width: 24, color: Colors.blue),
                                            SizedBox(width: 8),
                                            Text(
                                              'Trust Wallet',
                                              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          child: Row(
                                            children: [
                                              Image.network('$osImageBaseUrl/icons/os_ic_ethereum.png', height: 24, width: 24, color: Colors.redAccent),
                                              SizedBox(width: 8),
                                              Text(
            ...
            Expanded(
              child: MaterialButton(
                height: 50,
                color: Colors.blue,
                child: Text('View on nftmarkrtplace.io',
                    style: TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
