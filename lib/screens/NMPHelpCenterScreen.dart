  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:
            Text('Help Center', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.titleMedium!.color)),
      ),
      body: Container(
      ...
      bottomNavigationBar: Container(
        ...
        child: MaterialButton(
          ...
          child: Text('Visit support.nftmarkrtplace.io', style: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.bold)),
          onPressed: () {
            // Navigator.pop
            // (context);
          },
