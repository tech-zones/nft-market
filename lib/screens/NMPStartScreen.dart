...
import 'package:opensea_ui/screens/NMPDashboardScreen.dart';
            ...
            children: [
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network('$osImageBaseUrl/os_appIcon.png', height: 60, width: 60, fit: BoxFit.cover),
                ),
              ),
              SizedBox(height: 30),
              Text(
              ...
              MaterialButton(
                ...
                onPressed: () {
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => NMPDashboardScreen()),
