...
import 'package:opensea_ui/components/NMPRankingBottomSheet.dart';
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 16),
                      Image.network(ranking[index].categoryIcon!, height: 30, width: 30, color: Colors.blue),
                      SizedBox(width: 8),
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                      ...
                      Image.network('$osImageBaseUrl/icons/os_ic_token.png', height: 20, width: 20, color: context.theme.iconTheme.color),
                      SizedBox(width: 2),
                      Text(
