...
import 'package:opensea_ui/screens/NMPNotableDropsDetailsScreen.dart';
import 'package:opensea_ui/fragments/NMPRankingsFragment.dart';
import 'package:opensea_ui/screens/NMPCategoriesDetailsScreen.dart';
import 'package:opensea_ui/screens/NMPTrendingCollectionsDetailsScreen.dart';
import 'package:opensea_ui/utils/OSConstants.dart';
import 'package:opensea_ui/utils/OSDataProvider.dart';
import 'package:opensea_ui/components/NMPSellerItemComponent.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Image.network('$osImageBaseUrl/os_appIcon.png', height: 60, width: 60, fit: BoxFit.cover),
            Text(
              'NFT Market Place',
